...
- Listening、Thinking、SpeakingおよびAgent ExecutionのVisual StateはPhase 4 Designで決定する
- Particle Meshの流動Animation方式はPhase 2〜4 Design後に再評価する
- Rive、Shader、Painter継続または専用Rendererの選択は実要件とPerformance検証に基づいて決定する
